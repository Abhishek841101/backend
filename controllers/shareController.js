...
// 🔹 Share a post (internal or external)
// export const sharePost = async (req, res) => {
//   try {
...
//     // Optional receiver for app-internal share
//     let receiver;
//     if (receiverId) {
...
//       message: message || "",
//       link,
//       external: external || false, // external share flag
//     });

//     await newShare.save();

//     // 🔴 Real-time notification only if internal share
