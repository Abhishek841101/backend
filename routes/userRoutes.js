...
// // POST ROUTES
// // =========================
// router.post("/posts", checkUserAuth, upload.array("media", 5), PostController.createPost);
// router.get("/posts/:username", checkUserAuth, PostController.getUserPosts);
...
// router.post("/", auth, upload.single('image'), postsController.uploadPost);
...
// // Add comment
// router.post("/:postId/comment", auth, postsController.addComment);
...
// import checkUserAuth from "../middlewares/auth-middleware.js";
// // Remove duplicate import: import postsController from "../controllers/PostController.js";
// import { sharePost, getReceivedShares, getSentShares } from "../controllers/shareController.js";
// const router = express.Router();
// const upload = multer({ dest: "uploads/" });
...
// // POST ROUTES - UPDATED
// // =========================
// // Upload post with image - using single file upload
// router.post("/posts", checkUserAuth, upload.single("image"), PostController.uploadPost);
...
// // Old route (keep for compatibility or remove if not needed)
// router.get("/posts/:username", checkUserAuth, PostController.getUserPosts);
...
// // CONTEST ROUTES
// // =========================
// // Apply auth middleware to all contest routes
...
// router.post("/upload", upload.single("video"), uploadReel);  // ✅ multer integrated


// router.post("/share", checkUserAuth, sharePost); // Share post to user
// router.get("/shares/received/:userId", checkUserAuth, getReceivedShares); // Get received shares
...
// POST ROUTES
// =========================
router.post("/posts", checkUserAuth, uploadMiddleware.single("image"), PostController.uploadPost);
router.get("/posts", checkUserAuth, PostController.getPosts);
router.get("/posts/:postId", checkUserAuth, PostController.getPostById);
router.delete("/posts/:postId", checkUserAuth, PostController.deletePost);
router.post("/posts/:postId/like", checkUserAuth, PostController.likePost);
